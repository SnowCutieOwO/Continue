...
见“[在配置中定义数据](config-packs.config-development.defining-data-in-configs.md)”了解详情。
...
* NoiseSampler 中的 IMAGE：
  ...
  <badge type="tip" text="image" /> [字符串](config-packs.config-documentation.config-objects.string.md) - 在配置包目录中指向图片的相对路径。（对于 Windows 用户：请使用正斜杠 `/` 而非反斜杠 `\\`）
...
* NoiseSampler 中的  DISTANCE：
  ...
  <badge type="tip" text="distance-function" /> [字符串](config-packs.config-documentation.config-objects.string.md) - 用于计算采样点位与配置点之间距离的函数。
...
* NoiseSampler 中的 DISTANCE_TRANSFORM：
  ...
  <badge type="tip" text="normalization" /> [字符串](config-packs.config-documentation.config-objects.string.md)
...
* Image 中的 BITMAP：
  ...
  <badge type="info" text="path-format" /> [字符串](config-packs.config-documentation.config-objects.string.md) - 在配置包目录中指向图片的相对路径。（对于 Windows 用户：请使用正斜杠 `/` 而非反斜杠 `\\`）
...
* MathFunction 中的 map：
  ...
  <badge type="tip" text="arguments" /> [列表](config-packs.config-documentation.config-objects.list.md)<[字符串](config-packs.config-documentation.config-objects.string.md)>

* pack.yml 中的 base：

  <badge type="info" text="id" /> [字符串](config-packs.config-documentation.config-objects.string.md) - 配置包的 ID。
...
* Image 中的 STITCHED_BITMAP：
  ...
  <badge type="info" text="path" /> [字符串](config-packs.config-documentation.config-objects.string.md) - 在配置包目录中指向图片的相对路径格式字符串。（对于 Windows 用户：请使用正斜杠 `/` 而非反斜杠 `\\`）
...
* NoiseSampler 中的 EXPRESSION_NORMALIZER：
  ...
  <badge type="tip" text="variables" /> [映射表](config-packs.config-documentation.config-objects.map.md)<[字符串](config-packs.config-documentation.config-objects.string.md)，[浮点数](config-packs.config-documentation.config-objects.float.md)> - 可用在 `expression` 中的额外命名变量映射表。
...
* NoiseSampler 中的 EXPRESSION_NORMALIZER：
  ...
  <badge type="tip" text="samplers" /> [映射表](config-packs.config-documentation.config-objects.map.md)<[字符串](config-packs.config-documentation.config-objects.string.md)，[维度适用采样器](config-packs.config-documentation.config-objects.dimensionapplicablesampler.md)> - 可以用在表达式中的额外命名噪声采样器。

* NoiseSampler 中的  CELLULAR：

  <badge type="tip" text="distance" /> [字符串](config-packs.config-documentation.config-objects.string.md) - 计算细胞边缘距离的方法。
