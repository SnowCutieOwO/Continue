...
这种类型的配置包含了[地物](config-packs.config-documentation.config-objects.feature.md)实例。
...
由配置创建的[地物](config-packs.config-documentation.config-objects.feature.md)实例可通过这个参数区分。
