...
* [Fabric 服务器及客户端 >](getting-started.fabric-installation.md)
  Fabric 为 Terra 最初开发的平台。如果你只是在单人游戏或与好友一起玩的小型服务器中使用，则建议选择 Fabric。

* [Quilt 服务器及客户端 >](getting-started.quilt-installation.md)
  如果你只是在单人游戏或与好友一起玩的小型服务器中使用，则建议选择 Quilt。

* [Forge 服务器及客户端 >](getting-started.forge-installation.md)
