...
* ColorSampler 中的 COLOR：

  <badge type="info" text="color" /> [颜色字符串](config-packs.config-documentation.config-objects.colorsampler.md) - 输出的颜色。
