...
若要在附属中访问 [Platform](https://ci.codemc.io/job/PolyhedralDev/job/Terra/javadoc/com/dfsek/terra/api/Platform.html)，请先使用[依赖注入](terra-api.api-concepts.dependency-injection.md)。
