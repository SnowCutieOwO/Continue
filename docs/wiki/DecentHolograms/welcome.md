...
* **多种类型**  
  DecentHolograms 允许你显示的东西不只是基础的文本。它允许你显示[悬浮物品](general/formats-colors/index.md#icon-物品)，[盔甲架头](general/formats-colors/index.md#head-物品)形式的方块/物品（包括其[小型变种](general/formats-colors/index.md#smallhead-物品)），甚至是[实体](general/formats-colors/index.md#entity-实体)。
* **API**  
