...
1. 下载面向 Bukkit 的 Terra。你可以在[这里](../versions.md)浏览对应 Minecraft 版本的Terra 下载链接。
...
[通过 Bukkit 设置生成器](bukkit-world-creation.md) >

[通过世界管理插件设置生成器](worldmanager-world-creation.md) >