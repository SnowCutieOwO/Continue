...
![](_images/grass_64x64_50pcthreshold.png)
...
![](_images/grass_64x64_25pcthreshold.png)
...
|原噪声图像|分段后噪声图像|
|:---:|:---:|
|![](_images/opensimplex2_64x64.png)|![](_images/posterized_opensimplex2_64x64.png)|

颜色只是便于描述，它们可以表示任何东西，例如群系、方块调色板等。

这个过程可以通过多个阈值应用于噪声实现：

![](_images/basic_example-05.png)
