...
这个地形包提供了许多的预设配置及变量！见“[修改已有地形包](config-development/modifying-an-existing-pack.md)”章节了解更多。
...
![](_images/ReimagEND.png)

## Terra Backrooms

**作者：** Giuca002\
**源码：** <https://github.com/Giuca002/terra-backrooms>\
**支持版本：** 6.4+.x

用于生成后室地形的 Terra 配置包。

![](_images/TerraBackrooms.png)
