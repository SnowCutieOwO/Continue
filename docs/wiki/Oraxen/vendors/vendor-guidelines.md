...
4. 如果你在制作自定义盔甲，需要注意的是不同分辨率的贴图不能混用。
    ...
    4. 装备对格式要求非常严格，非常建议参考[装备](../configuration/custom-armors/index.md)部分的教程进行制作。
...
你可以在[音符盒机制](../mechanics/noteblock-mechanic/index.md)及其子页面下了解更多。
...
有关的子机制可以在[绊线钩机制](../mechanics/stringblock-mechanic/index.md)及其子页面下浏览。
