...
| **分玩家语言显示**<br>高级语言消息支持（可以在消息中嵌入 BossBar、ActionBar、声音、标题），[点此](../features/advanced-language-management.md)了解更多！ |❌|✅|
| **潜影盒出售（Alpha）**<br>在 `config.yml` 启用之后，插件支持检测潜影盒内的物品并自动出售，在所有出售场景均有效，包括但不限于普通出售、出售魔杖、一键出售界面、出售魔箱等。                                                                    |❌|✅|
| **游戏编辑器**<br>可以通过 `/shop editor` 命令打开游戏内编辑器。|❌|✅|
| **搜索界面**<br>你可以在搜索界面搜索你需要的物品，[点此](../menus/search-menus-premium.md)了解更多！|❌|✅|
| **共享商品数据（Alpha）**<br>你可以设置多个商品共享同一个数据，例如购买/出售/限售/冷却次数等，[点此](../shops/shared-product-data-premium.md)了解更多！|❌|✅|
