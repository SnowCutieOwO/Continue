...
* 不支持 Folia 服务器。
* 出售魔箱无法和其他的箱子组合成双箱。
* 出售魔箱数据储存在世界中，如果世界损坏，出售魔箱的数据也不可恢复。
...
* 出售魔箱只在所在区块已加载，以及主人在线的情况下，才会工作。没有计划支持多人共享同一个出售魔箱的功能。
* 只有放置出售魔箱的玩家才会被视为主人。但是，所有玩家都可以破坏不属于自己的出售魔箱。
## 配置
...
出售魔箱的 `display-item` 物品只能使用箱子作为材料。否则，不能按照预期工作。
...
* send-sell-message: 出售魔箱每次出售时，是否给主人发送提示。
* price-empty: 出售魔箱没有任何历史时，在悬空字显示的上一次收益文本。
