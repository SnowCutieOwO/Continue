...
它们各自存在于配置的最顶部。这是商店配置，因此你可以在“[商店](../shops/shops.md)”页面找到更完整的配置解释。里面的标题会标出所有可以填入这里的配置项。
...
* `1` 也表示第一个定义的价格组。
* 你可以设置数量不限的价格和物品。所有选项都可以在“[单条目](../shops/products-config-single-thing.md)”章节详细浏览。
