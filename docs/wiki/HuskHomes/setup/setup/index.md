...
::: info 提示
若插件载入失败，请检查你是否运行了[不受支持的版本](../compatibility.md)。
:::
...
* 你现在可以按喜好编辑[配置文件](../config/index.md)与本地语言文件了。
...
* 找到每个子服上的 HuskHomes 的[配置文件](../config/index.md)（Spigot 端为 `~/plugins/HuskHomes/config.yml`，Fabric/Sponge 端为 `~/config/huskhomes/config.yml`）；
...
* [命令与权限](../../features/commands/index.md)
* [配置文件](../config/index.md)
* [数据库](../config/database.md)
* [Redis 支持](../config/redis.md)
* [语言贡献](../config/locales.md)