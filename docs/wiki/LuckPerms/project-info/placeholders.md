...
| `%luckperms_prefix_element%`                    | `<元素>`                  | 通过给定的“元数据组”元素定义返回一个前缀元素。更多信息请见[前缀叠加](../how-to/stack-prefixes.md) |
| `%luckperms_suffix_element%`                    | `<元素>`                  | 通过给定的“元数据组”元素定义返回一个后缀元素。更多信息请见[后缀叠加](../how-to/stack-prefixes.md) |
