...
这里有两种方式为权限组设置权重：通过[命令](../command-usage/group.md#lp-group-权限组-setweight-权重)，或使用[编辑器](web-editor.md#luckperms-节点)。
...
这里有两种方法为前后缀设置权重：通过[命令](../command-usage/meta.md#lp-usergroup-玩家权限组-meta-setprefix-权重-前缀-情境)，或使用[编辑器](web-editor.md#luckperms-节点)。
