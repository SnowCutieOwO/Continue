...
![](_images/finding-lag-tickmonitor.png '一张图片，显示了滴答监视器的开启和关闭，以及结果显示。')
...
![](_images/finding-lag-tickmonitor-demo.png '一张图片，显示了滴答监控器检测到的卡顿。')
...
![](_images/finding-lag-example-viewer.png '一张图片，显示了 WorldEdit 为本次造成卡顿的根源。')