...
![](_images/ticks-with-sleeping.png '服务器在空闲时的刻循环示意图。')
...
![](_images/ticks-lagging.png '服务器在卡顿时的刻循环示意图。')
...
![](_images/ticks-in-profiler.png '一张截图，显示了健康报告中的刻循环方法。')
