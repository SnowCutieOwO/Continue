# 语言贡献
HuskHomes 支持许多种类的语言，这些语言由社区成员贡献。插件的默认语言为 `en-gb`（英文-英国）。消息文本以 [MiniMessage](https://docs.advntr.dev/minimessage/index.html) 格式标注。
...
* 不要翻译 [MiniMessage](https://docs.advntr.dev/minimessage/index.html) 的格式标签，以及命令文本；只需要翻译英语原文的描述；
* 每段语言文本需处在同一行，且要去掉页眉；
* 使用 ISO 639-1 标准的[语言代码](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)来命名你所翻译语言的文件；
* 如果你可以，那么可以在翻译贡献者处添加你自己的名字，或者我们也会帮你完成这项工作。
