<PageHeader title="属性修饰符" subtitle="属性修饰符相关教程" />

**属性修饰符（Modifiers）** 是玩家身上临时生效的[属性](index.md)效果。它们有三种不同类型，可通过命令交互。普通的修饰符依赖于名称，除非被移除否则持续生效。物品修饰符在持有物品时生效。装备修饰符在穿戴时生效。
