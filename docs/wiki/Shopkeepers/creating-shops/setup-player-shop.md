...
本章节描述了设置与编辑不同类型玩家商店的教程。更多编辑商店的信息可参阅[编辑商店](editing-shops.md)章节。
...
首先，将你需要出售的物品放置在箱子中。你也可以通过[变量物品](placeholder-items.md)设置你尚未得到的物品。若要出售成书，你需要使用特殊的复印商店。
...
通常情况下，你只能收购已拥有至少一个的物品。但是，你也可以使用重命名的物品替代当前缺少的物品。详见[变量物品](placeholder-items.md)章节。
...
你也可以使用[变量物品](placeholder-items.md)设置你还没有的物品交易。
