...
*最新版本的 API 可以在[这里](../coreprotect-api.md)找到。*
</font>
...
确保你正在使用 CoreProtect 20.2 或更高版本。将其作为外部 jar 文件导入你的 IDE。  
另外，如果你在使用 maven，你还可以通过 https://maven.playpro.com  仓库（net.coreprotect, 20.2）添加。
