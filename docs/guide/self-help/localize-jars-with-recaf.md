...
如果你的编辑器是英文，请参考本文最后的[后记](#01-切换-recaf-的显示语言)部分找到解决方案。

:::

![](_images/code-strings.png "注意到图中有许多的字符串，记住它们。")
...
![](_images/before-modification.png "修改前的汇编代码")

![](_images/after-modificationn.png "修改后的汇编代码")

![](_images/code-after-modification.png "修改后的反编译代码")
...
Recaf 一开始的字体并不是非常令人满意。如果你需要修改字体，点击上方工具栏的“配置”，再找到“UI 字体”与“等宽文本（如编辑器）字体”这两项，在右侧的展开式列表中选择你需要的字体即可。个人推荐 [Maple Mono NF CN](https://font.subf.dev/zh-cn/download/)。
