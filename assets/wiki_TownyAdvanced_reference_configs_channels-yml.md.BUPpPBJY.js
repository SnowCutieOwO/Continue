import{_ as h,C as i,c as p,o as e,aa as t,G as a}from"./chunks/framework.Cn7WEiMX.js";const A=JSON.parse('{"title":"默认 channel.yml","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/TownyAdvanced/reference/configs/channels-yml.md","filePath":"wiki/TownyAdvanced/reference/configs/channels-yml.md"}'),k={name:"wiki/TownyAdvanced/reference/configs/channels-yml.md"};function r(d,s,g,c,E,y){const n=i("NolebaseGitContributors"),l=i("NolebaseGitChangelog");return e(),p("div",null,[s[0]||(s[0]=t(`<h1 id="默认-channel-yml" tabindex="-1">默认 channel.yml <a class="header-anchor" href="#默认-channel-yml" aria-label="Permalink to &quot;默认 channel.yml&quot;">​</a></h1> <div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># This file contains all configuration data for the TownyChat channels.</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    range</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;100&#39;</span></span></code></pre></div>`,3)),a(n),a(l)])}const D=h(k,[["render",r]]);export{A as __pageData,D as default};
