import{_ as o,C as n,c as i,o as t,aa as l,G as a}from"./chunks/framework.Cn7WEiMX.js";const _=JSON.parse('{"title":"配置服务器","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/LibreLogin/guides/configuring-servers.md","filePath":"wiki/LibreLogin/guides/configuring-servers.md"}'),r={name:"wiki/LibreLogin/guides/configuring-servers.md"};function c(b,s,g,d,u,h){const e=n("NolebaseGitContributors"),p=n("NolebaseGitChangelog");return t(),i("div",null,[s[0]||(s[0]=l(`<h1 id="配置服务器" tabindex="-1">配置服务器 <a class="header-anchor" href="#配置服务器" aria-label="Permalink to &quot;配置服务器&quot;">​</a></h1> <p>自 LibreLogin <strong>v0.12.0</strong> 以来，插件便允许配置强制端口。在你首次打开配置文件时，这部分配置会看起来像这样：</p> <div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 在完成登录后传送至的服务器。对应服务器必须在群组配置文件中注册。</span></span>
...
<span class="line"><span>    ]</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,16)),a(e),a(p)])}const v=o(r,[["render",c]]);export{_ as __pageData,v as default};
