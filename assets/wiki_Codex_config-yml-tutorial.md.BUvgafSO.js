import{_ as p,C as i,c as t,o as h,aa as e,G as a}from"./chunks/framework.Cn7WEiMX.js";const A=JSON.parse('{"title":"config.yml 教程","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/Codex/config-yml-tutorial.md","filePath":"wiki/Codex/config-yml-tutorial.md"}'),k={name:"wiki/Codex/config-yml-tutorial.md"};function r(E,s,d,o,g,c){const n=i("NolebaseGitContributors"),l=i("NolebaseGitChangelog");return h(),t("div",null,[s[0]||(s[0]=e(`<h1 id="config-yml-教程" tabindex="-1">config.yml 教程 <a class="header-anchor" href="#config-yml-教程" aria-label="Permalink to &quot;config.yml 教程&quot;">​</a></h1> <div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 加入服务器时显示更新提示.</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">config_version</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">2</span></span></code></pre></div>`,3)),a(n),a(l)])}const D=p(k,[["render",r]]);export{A as __pageData,D as default};
