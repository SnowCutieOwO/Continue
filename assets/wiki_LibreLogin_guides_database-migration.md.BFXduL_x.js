...
<span class="line"><span>}</span></span></code></pre></div><p>完成设置之后重启群组端，控制台就会出现有关的状态信息。</p> <p>在迁移完成之后，关闭群组端，并将配置文件中 <code>on-next-startup</code> 选项改为 false。</p> <p>现在，所有数据应已迁移完毕，若出现任何问题，请在 Github 提交议题。</p> `,21)),n(e),n(p)])}const y=i(c,[["render",r]]);export{k as __pageData,y as default};
