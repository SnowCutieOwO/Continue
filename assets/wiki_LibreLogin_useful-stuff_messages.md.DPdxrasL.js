import{_ as p,C as i,c as t,o as k,a9 as h,G as a}from"./chunks/framework.DuenUNqn.js";const c=JSON.parse('{"title":"消息文本","description":"","frontmatter":{"breadcrumbs":[{"title":"Continue Project","link":"/wiki"},{"title":"LibreLogin","link":"/wiki/LibreLogin"},{"title":"useful-stuff","link":""},{"title":"消息文本","link":"/wiki/LibreLogin/useful-stuff/messages"}]},"headers":[],"relativePath":"wiki/LibreLogin/useful-stuff/messages.md","filePath":"wiki/LibreLogin/useful-stuff/messages.md"}'),e={name:"wiki/LibreLogin/useful-stuff/messages.md"};function r(E,s,g,o,d,y){const n=i("NolebaseGitContributors"),l=i("NolebaseGitChangelog");return k(),t("div",null,[s[0]||(s[0]=h(`<h1 id="消息文本" tabindex="-1">消息文本 <a class="header-anchor" href="#消息文本" aria-label="Permalink to &quot;消息文本&quot;">​</a></h1><div class="language-toml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#  !!文件为 HOCON 格式!!</span></span>
