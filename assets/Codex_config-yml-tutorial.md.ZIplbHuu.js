import{_ as t,C as i,c as p,o as h,a9 as e,G as a}from"./chunks/framework.BMko4Wr3.js";const A=JSON.parse('{"title":"config.yml 教程","description":"","frontmatter":{"breadcrumbs":[{"title":"Continue Project","link":"/Codex"},{"title":"config.yml 教程","link":"/Codex/config-yml-tutorial"}]},"headers":[],"relativePath":"Codex/config-yml-tutorial.md","filePath":"Codex/config-yml-tutorial.md"}'),k={name:"Codex/config-yml-tutorial.md"};function r(o,s,d,E,c,g){const n=i("NolebaseGitContributors"),l=i("NolebaseGitChangelog");return h(),p("div",null,[s[0]||(s[0]=e(`<h1 id="config-yml-教程" tabindex="-1">config.yml 教程 <a class="header-anchor" href="#config-yml-教程" aria-label="Permalink to &quot;config.yml 教程&quot;">​</a></h1><div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 加入服务器时显示更新提示.</span></span>
