import{_ as l,C as i,c as h,o as k,aa as t,G as a}from"./chunks/framework.Cn7WEiMX.js";const o=JSON.parse('{"title":"击杀任务","description":"","frontmatter":{},"headers":[],"relativePath":"wiki/SuperiorSkyblock2/overview/missions/killsmissions.md","filePath":"wiki/SuperiorSkyblock2/overview/missions/killsmissions.md"}'),e={name:"wiki/SuperiorSkyblock2/overview/missions/killsmissions.md"};function E(r,s,d,g,y,F){const n=i("NolebaseGitContributors"),p=i("NolebaseGitChangelog");return k(),h("div",null,[s[0]||(s[0]=t(`<h1 id="击杀任务" tabindex="-1">击杀任务 <a class="header-anchor" href="#击杀任务" aria-label="Permalink to &quot;击杀任务&quot;">​</a></h1> <p>物品任务模块记录并处理玩家在岛屿上击杀生物的行为。你可以通过它给玩家发布需要击杀某个生物的任务。任务会在玩家击杀生物时检查进度并记录相关数据。</p> <h2 id="所需设置" tabindex="-1">所需设置 <a class="header-anchor" href="#所需设置" aria-label="Permalink to &quot;所需设置&quot;">​</a></h2> <h3 id="required-entities" tabindex="-1"><code>required-entities</code> <a class="header-anchor" href="#required-entities" aria-label="Permalink to &quot;\`required-entities\`&quot;">​</a></h3> <p>完成任务所需击杀的实体。</p> <p>该部分的示例配置可在下文找到。</p> <h4 id="设置类型" tabindex="-1">设置类型 <a class="header-anchor" href="#设置类型" aria-label="Permalink to &quot;设置类型&quot;">​</a></h4> <p>配置</p> <h2 id="示例配置" tabindex="-1">示例配置 <a class="header-anchor" href="#示例配置" aria-label="Permalink to &quot;示例配置&quot;">​</a></h2> <div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 使用的任务文件名称</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">mission-file</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">KillsMissions</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 是否在完成任务后重置玩家的生物击杀计数?</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;eco give %player% 1000&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;is admin msg %player% &amp;e&amp;l击杀 | &amp;7成功完成任务 杀手 I!&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;is admin msg %player% &amp;e&amp;l击杀 | &amp;7你的剑才刚刚见血 ... 杀更多生物吧!&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;is admin msg %player% &amp;e&amp;l击杀 | &amp;7&amp;o有关下个任务的更多信息, 请输入命令 /is missions 查看&#39;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 完成任务所需要击杀的实体种类及其数量.</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">required-entities</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    name</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;a杀手 I&#39;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;7击杀 5 个敌怪.&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;6需要击杀:&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;8 - &amp;7x5 骷髅/苦力怕/僵尸/蜘蛛&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&#39;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;8 - &amp;7$1,000&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;6已击杀敌怪: &amp;7{1}/5&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;6任务进度: &amp;7{0}%&#39;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;8 - &amp;7$1,000&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;6已击杀敌怪: &amp;75/5&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;6任务进度: &amp;7100%&#39;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;6已击杀敌怪: &amp;75/5&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;6任务进度: &amp;7100%&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;a&amp;l ✔ &amp;7已领取过.&#39;</span></span></code></pre></div>`,19)),a(n),a(p)])}const m=l(e,[["render",E]]);export{o as __pageData,m as default};
