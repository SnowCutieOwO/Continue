...
自定义物品的格式与其他物品完全相同（包括 material、pos、display_name、lore 等）。对这些物品设置自定义点击操作，或是插入 PlaceholderAPI 的变量都是可以的。</p> `,170)),a(d),a(t)])}const f=n(r,[["render",p]]);export{g as __pageData,f as default};
