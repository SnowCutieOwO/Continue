import{_ as p,C as i,c as k,o as h,an as t,G as a}from"./chunks/framework.b7TVlVDK.js";const D=JSON.parse('{"title":"BungeeCord","description":"","frontmatter":{"breadcrumbs":[{"title":"Continue Project","link":"/FallbackServer"},{"title":"BungeeCord","link":"/FallbackServer/files.configuration"}]},"headers":[],"relativePath":"FallbackServer/files.configuration.md","filePath":"FallbackServer/files.configuration.md"}'),e={name:"FallbackServer/files.configuration.md"};function E(r,s,d,g,y,c){const n=i("NolebaseGitContributors"),l=i("NolebaseGitChangelog");return h(),k("div",null,[s[0]||(s[0]=t(`<h1 id="bungeecord" tabindex="-1">BungeeCord <a class="header-anchor" href="#bungeecord" aria-label="Permalink to &quot;BungeeCord&quot;">​</a></h1><div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#  █████▒▄▄▄       ██▓     ██▓     ▄▄▄▄    ▄▄▄       ▄████▄   ██ ▄█▀     ██████ ▓█████  ██▀███   ██▒   █▓▓█████  ██▀███</span></span>
