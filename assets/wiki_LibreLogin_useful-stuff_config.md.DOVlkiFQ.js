import{_ as t,C as i,c as p,o as h,aa as k,G as a}from"./chunks/framework.ByRpVre_.js";const E=JSON.parse('{"title":"配置文件","description":"","frontmatter":{"breadcrumbs":[{"title":"Continue Project","link":"/wiki"},{"title":"LibreLogin","link":"/wiki/LibreLogin"},{"title":"useful-stuff","link":""},{"title":"配置文件","link":"/wiki/LibreLogin/useful-stuff/config"}]},"headers":[],"relativePath":"wiki/LibreLogin/useful-stuff/config.md","filePath":"wiki/LibreLogin/useful-stuff/config.md"}'),e={name:"wiki/LibreLogin/useful-stuff/config.md"};function r(y,s,g,d,c,o){const n=i("NolebaseGitContributors"),l=i("NolebaseGitChangelog");return h(),p("div",null,[s[0]||(s[0]=k(`<h1 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h1><div class="language-toml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#  !!文件为 HOCON 格式!!</span></span>
