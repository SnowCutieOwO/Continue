import{_ as t,C as a,c as l,o as h,a9 as p,G as i}from"./chunks/framework.BAB8_kX7.js";const u=JSON.parse('{"title":"缓存存储配置","description":"","frontmatter":{"breadcrumbs":[{"title":"Continue Project","link":"/ajLeaderboards"},{"title":"缓存存储配置","link":"/ajLeaderboards/configs.cache-storage"}]},"headers":[],"relativePath":"ajLeaderboards/configs.cache-storage.md","filePath":"ajLeaderboards/configs.cache-storage.md"}'),k={name:"ajLeaderboards/configs.cache-storage.md"};function r(o,s,d,c,g,E){const n=a("NolebaseGitContributors"),e=a("NolebaseGitChangelog");return h(),l("div",null,[s[0]||(s[0]=p(`<h1 id="缓存存储配置" tabindex="-1">缓存存储配置 <a class="header-anchor" href="#缓存存储配置" aria-label="Permalink to &quot;缓存存储配置&quot;">​</a></h1><p>此为默认的缓存配置。你可以用它来设置本插件缓存的存储方式。</p><div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># In this file, you can control where the cache is stored.</span></span>
