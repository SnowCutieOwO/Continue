import{_ as l,C as a,c as t,o as p,aa as h,G as i}from"./chunks/framework.Cn7WEiMX.js";const A=JSON.parse('{"title":"主配置文件","description":"","frontmatter":{"breadcrumbs":[{"title":"Continue Project","link":"/wiki"},{"title":"ajLeaderboards","link":"/wiki/ajLeaderboards"},{"title":"configs","link":""},{"title":"主配置文件","link":"/wiki/ajLeaderboards/configs/main-config"}]},"headers":[],"relativePath":"wiki/ajLeaderboards/configs/main-config.md","filePath":"wiki/ajLeaderboards/configs/main-config.md"}'),k={name:"wiki/ajLeaderboards/configs/main-config.md"};function r(d,s,o,c,y,g){const n=a("NolebaseGitContributors"),e=a("NolebaseGitChangelog");return p(),t("div",null,[s[0]||(s[0]=h(`<h1 id="主配置文件" tabindex="-1">主配置文件 <a class="header-anchor" href="#主配置文件" aria-label="Permalink to &quot;主配置文件&quot;">​</a></h1> <p>此为默认的主配置文件。所有设置都可在注释中找到详细解读。</p> <div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># ^ Change those in messages.yml now</span></span></code></pre></div>`,5)),i(n),i(e)])}const u=l(k,[["render",r]]);export{A as __pageData,u as default};
